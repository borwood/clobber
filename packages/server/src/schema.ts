// The full per-workspace SQLite DDL, executed (CREATE … IF NOT EXISTS) on every
// open by createDatabase. New tables land here; column-altering migrations live
// in their own `migrate*` modules and run after this in db.ts.
export const SCHEMA = `
